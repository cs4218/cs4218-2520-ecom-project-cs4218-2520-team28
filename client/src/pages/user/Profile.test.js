...
jest.mock("../../components/UserMenu", () => () => (
  <div data-testid="user-menu-mock" />
));
...
describe("Profile Component", () => {
  ...
  it("should handle API error on form submission", async () => {
    // After fixing Profile.js, API errors should be returned as { error: "..." }
    const apiError = { error: "Invalid input data" };
    ...
    await waitFor(() => {
      expect(toast.error).toHaveBeenCalledWith(apiError.error);
    });
